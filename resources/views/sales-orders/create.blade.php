        ...
        <div class="rounded-2xl border border-ink/10 bg-white shadow-card overflow-hidden mb-6">
            <div class="px-6 py-4 border-b border-ink/10 flex items-center justify-between">
                <div>
                    ...
                    <p class="text-xs text-ink/40 mt-0.5">Opsional — mis. ongkir ke customer, biaya packing. Tanggal otomatis ikut Tanggal SO, tidak menambah Total Transaksi di atas, dan baru masuk ke Pengeluaran setelah ditandai "Lunas" di halaman detail SO.</p>
                </div>
