...
@section('content')
    ...
    <div id="expenses-table-container">
        @include('reports._expenses-table')
    </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        window.initAjaxListSearch({
            inputEl: document.getElementById('expenses-search'),
            containerEl: document.getElementById('expenses-table-container'),
            baseUrl: '{{ route('reports.expenses') }}',
            getExtraParams: () => ({
