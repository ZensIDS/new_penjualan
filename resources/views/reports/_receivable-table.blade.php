{{--
    Partial ini dirender penuh saat load awal halaman (di-include reports/receivable.blade.php)
    DAN dikirim sebagai response AJAX saat user mengetik di kolom pencarian atau klik
    pagination (lihat ReportController@receivable & initAjaxListSearch di layouts/app.blade.php).
--}}
            ...
            <button type="button" @click="open = !open"
                ...
                <div class="flex items-center gap-3 min-w-0">
                    ...
                    <div class="min-w-0">
                        ...
                        <p class="text-xs text-ink/40">{{ $so['customer'] }} &middot; {{ \Illuminate\Support\Carbon::parse($so['so_date'])->format('d M Y') }}</p>
                    </div>
                </div>
