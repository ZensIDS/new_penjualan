...
<div>
    ...
    <div class="flex items-center justify-between mb-4 gap-3">
        <form method="GET" action="{{ route('reports.payable') }}" class="relative flex-1 max-w-sm">
            ...
            <input type="text" name="search" value="{{ $search }}" placeholder="Cari nomor PO atau supplier..." onchange="this.form.submit()"
