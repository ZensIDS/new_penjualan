...
<div>
    ...
    {{-- KPI: agregasi SQL atas SELURUH PO belum lunas, independen dari pagination/pencarian --}}
    ...
    <div id="payable-table-container">
        @include('reports._payable-table')
    </div>
</div>
@endsection
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        window.initAjaxListSearch({
            inputEl: document.getElementById('payable-search'),
            containerEl: document.getElementById('payable-table-container'),
            baseUrl: '{{ route('reports.payable') }}',
        });
    });
</script>
@endpush
